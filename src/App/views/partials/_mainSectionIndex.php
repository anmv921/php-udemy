...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <div class="flex items-center justify-between border-b border-gray-200 pb-4">
        ...
        <div class="flex space-x-4">
            ...
            class="flex items-center p-2 bg-sky-50 text-xs 
            text-sky-900 hover:bg-sky-500 hover:text-white transition rounded">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" 
                    stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
    ...
    <form method="GET" class="mt-4 w-full">
        ...
        <div class="flex">
            ...
            if ( empty($searchTerm) ==false ) {
                echo e( (string) $searchTerm);
            }
            ?>"
            name="s" type="text" class="w-full rounded-l-md border-0 
            ...
            <button type="submit" 
            class="rounded-r-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold 
            ...
            <tr>
                ...
                <td class="p-4 text-sm text-gray-600">
                    ...
                    <div class="inline-block relative cursor-pointer">
                        <a 
                        href="/transaction/<?= e($transaction["id"]) ?>/receipt/<?= e($receipt["id"]) ?>" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(109 40 217)" 
                        class="w-10 h-10">
                        <path stroke-linecap="round" 
                ...
                <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                    ...
                    class="p-2 bg-amber-50 text-xs text-amber-900 
                    hover:bg-amber-500 hover:text-white transition rounded">
                    ...
                    class="p-2 bg-emerald-50 text-xs text-emerald-900 
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <?php if($currentPage > 1) : ?>
            ...
            <a href="/?<?= $previousPageQuery ?>" class="inline-flex items-center border-t-2 
            border-transparent pr-1 pt-4 text-sm font-medium 
